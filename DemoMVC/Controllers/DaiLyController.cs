...
namespace DemoMVC.Controllers
{
    public class DaiLyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DaiLyId,DaiLyName,Address")] DaiLy daiLy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("DaiLyId,DaiLyName,Address")] DaiLy daiLy)
        {
            if (id != daiLy.DaiLyId)
            {
                return NotFound();
        ...
        {
          return (_context.DaiLy?.Any(e => e.DaiLyId == id)).GetValueOrDefault();
        }
    }
}
